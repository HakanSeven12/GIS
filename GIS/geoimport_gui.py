...
class navigator:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/Navigator.svg',
            'MenuText': 'Navigator',
            'ToolTip': 'Navigator'
        }
...
class set_geolocation:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/SetGeoLocation.svg',
...
class import_tms:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/ImportTMS.svg',
            'MenuText': 'Import TMS',
...
class import_wms:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/ImportWMS.svg',
            'MenuText': 'Import WMS',
...
class import_wfs:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/ImportWFS.svg',
            'MenuText': 'Import WFS',
...
class import_osm:
    ...
    def GetResources(self):
        return {
            'Pixmap': icons_path + '/ImportOSM.svg',
            'MenuText': 'Import OSM',
            'ToolTip': 'Import OSM'
        }
